...
const RAW_COURSES: RawCourse[] = [
  ...
  ['First Year','Short Term','CE 1203D','Engineering Utilities 2 (Drafting)','1','CE Phys, CE PhysL, CE 1203'],
  ...
  ['Third Year','First Semester','CE 3142C','Quantity Surveying Computation','1','CE 2232, CE 2232D, CE 3142'],
