...
function optimizeLayout(): void {
  ...
  flowHint.textContent = `Auto sort reordered ${activeFilter} by dependency topology, placed prerequisite-free courses first, aligned prerequisite chains, and added vertical clearance only where routing needed it.`;
}
